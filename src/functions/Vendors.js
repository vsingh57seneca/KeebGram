...
module.exports = {
  ...
  getVendorByAccountId: async (accountId) => {
    ...
    console.log("(vendors.js)looking for vendor with acc id:", accountId);
    let url = `${API_URL[DEBUG]}/api/vendors/getVendorByAccountId?account_id=${accountId}`;
    ...
    try {
      ...
      console.error("(vendors.js)Error fetching vendor data", error);
      return null;
    }
  },
};
